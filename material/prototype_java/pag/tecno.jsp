<%-- 
    Document   : tecno
    Created on : 21/10/2019, 02:06:11
    Author     : maran
--%>
...
<body>
    ...
    <div>
        ...
        <p style="text-align: center;">
            <h3>The Technologies below were used to create this site:</h3></p>
        <br>
        <br>
        <ul>
            ...
            <li><a href="https://colorschemedesigner.com/csd-3.5/">Color Scheme Designer</a></li>
            <li><a href="https://undraw.co/search">Undraw</a></li>
